...
# Circuit Breaker: apre dopo 3 fallimenti, reset dopo 60s
...
def fetch_flight_data_worker():
    print("Background Worker started. Waiting for Kafka...")
    kafka_producer = None
    ...
    while True:
        if kafka_producer is None:
            try:
                ...
                print(f"Kafka not ready ({str(e)}). Retrying next cycle.")
        ...
        try:
            ...
            print(f"Monitoring {len(airports)} airports.")
            ...
            for airport_code in airports:
                ...
                if kafka_producer:
                    ...
                    print(f" -> Skipping Kafka alert for {airport_code} (Producer not ready)")
